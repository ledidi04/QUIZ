    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            line-height: 1.7;
            color: var(--gray-800);
            background: linear-gradient(180deg, #f0f4ff 0%, var(--gray-50) 100%);
            display: flex;
        ...
        .score-circle {
            ...
            box-shadow: 0 0 0 8px rgba(0, 35, 149, 0.08);
        }
    ...
    <script>
        ...
        async function loadQuiz(matiere) {
            ...
            try {
                ...
                // Filtrer pour ne garder que les QCM avec options
                ...
                q.options.forEach((option, index) => {
                    ...
                    html += `
                        <button class="option-btn" 
                                ...
                                data-index="${index}">
                            <strong>${letter}.</strong> ${formatMath(option.texte)}
                        </button>
                    `;
                });
            } else {
            ...
            optionButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    userAnswers.push({
                        question: q.enonce,
                        type: q.type,
                        userAnswer: this.textContent.trim(),
                        correct: isCorrect
                    });
        ...
        /**
         * Gère une réponse (correcte ou non)
         */
        ...
        /**
         * Affiche le score final avec résumé
         */
        function showScore() {
            ...
            if (pourcentage >= 90) {
                emoji = '🏆';
                message = 'Excellent ! Tu maîtrises parfaitement cette matière !';
                messageColor = '#28a745';
            } else if (pourcentage >= 70) {
                emoji = '👏';
                message = 'Très bien ! Continue comme ça, tu progresses !';
                messageColor = '#28a745';
                ...
                emoji = '📚';
                message = 'Continue à réviser, tu vas y arriver !';
                messageColor = '#dc3545';
            }
            ...
            let html = `
                <div class="score-final">
                    ...
                    <a href="<?= $basePath ?>/9e/index.php" class="btn-back" style="max-width:300px;margin:0.5rem auto;">
                        ⬅️ Retour aux exercices
                    </a>
                </div>
            `;
            ...
            if (userAnswers.length > 0) {
                html += `
                    <div style="margin-top:2rem;">
                        <h3 style="text-align:center;margin-bottom:1rem;color:var(--gray-700);">
                            ...
                            <table class="summary-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Question</th>
                                        <th style="width:60px;">Résultat</th>
                                    </tr>
                                </thead>
                                <tbody>
                `;
                ...
                userAnswers.forEach((answer, index) => {
                    const shortQuestion = answer.question.length > 70 ?
                        answer.question.substring(0, 70) + '...' :
                        answer.question;
                    const rowClass = answer.correct ? 'row-correct' : 'row-wrong';
